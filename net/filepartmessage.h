...
public:
    ...
    FilePartMessage(ActionType actionType, QString dstPath, QString srcPath, const QByteArray& filePart = {}, int32_t partPosition = 0);
    ...
    static constexpr int32_t defaultPartSize = 1024*4;
